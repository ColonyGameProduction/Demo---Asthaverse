...
public class Kamera : MonoBehaviour
{
    ...
    {
        playableCharacters[playerNumber].gameObject.GetComponent<PlayerAction>().enabled = false; // turn off PlayerMovement script from previous main character        

        playableCharacters[playerNumber].gameObject.GetComponent<PlayerAction>().inputActions.InputPlayerAction.Shooting.Disable();
        playableCharacters[playerNumber].gameObject.GetComponent<PlayerAction>().inputActions.InputPlayerAction.SilentKill.Disable();
        playableCharacters[playerNumber].gameObject.GetComponent<PlayerAction>().inputActions.InputPlayerAction.ChangingWeapon.Disable();
    ...
    {
        playableCharacters[characterIndex].gameObject.GetComponent<PlayerAction>().enabled = true; // turn on PlayerMovement script for the new main character

        playableCharacters[playerNumber].gameObject.GetComponent<PlayerAction>().inputActions.InputPlayerAction.Shooting.Enable();
